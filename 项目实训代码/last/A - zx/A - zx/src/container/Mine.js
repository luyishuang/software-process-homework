        ...
        return(
            <div>
                ...
                <div className="mineonbody">
                    ...
                    <div style={{float:'5%',bottom:'0%',width:'90%',marginLeft:'5%',opacity:'0.56',height:'auto',backgroundColor:'rgb(247, 235, 221)'}}> 
        <div style={{textAlign:'center',paddingTop:'10%',fontSize:'20px'}}>{this.state.value}</div>
